...
public class AudioRecorder {
    ...
    public static class MediaRecorderConfig {
         ...
         * Constructor.
         *
         * @param audioEncodingBitRate Used for
         ...
         */
        public MediaRecorderConfig(int audioEncodingBitRate, int audioChannels, int audioSource,
                                   int audioEncoder) {
...
//
    ...
    private void appendToFile(@NonNull final String targetFileName, @NonNull final String
            newFileName) {
